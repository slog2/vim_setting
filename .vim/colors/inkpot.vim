...
if has("gui_running")
    ...
    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(255) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(73) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=3 ctermbg=" . "NONE"
...
hi phpIdentifier ctermfg=117
hi phpStructure ctermfg=215
hi phpDefine ctermfg=39
hi phpParent ctermfg=130
hi phpInclude ctermfg=39
hi phpRegion ctermfg=3
...
"hi StatusLine ctermfg=yellow ctermbg=darkblue
hi StatusLine ctermfg=black ctermbg=179
"hi MatchParen ctermfg=black ctermbg=white
hi matchparen ctermbg=57 ctermfg=3
"hi search ctermbg=237 ctermfg=7
hi search ctermbg=5 ctermfg=7
hi folded ctermbg=23 ctermfg=150
